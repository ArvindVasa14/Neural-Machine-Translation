...
import numpy as np
from NMT.seq2seq.DecoderRNN import DecoderRNN
...
def get_loader(batch_size, get_check_dataset=True):
    dataset= TranslationDataset("eng", "jap")
...
def translate(sentence, source_vocab:Vocabulary, target_vocab:Vocabulary, lang1, lang2):
    ...
    decoder = DecoderRNN(embed_size, hidden_size, target_vocab.get_vocab_size()).to(device)
...
# print(translate("when i was run faraway .", source_vocab, target_vocab, "eng", "jap"))
